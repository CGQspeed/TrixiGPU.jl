...
mesh =
    DGMultiMesh(dg, cells_per_dimension; periodicity = (true, false, true), is_on_boundary)
...
@inline function source_terms_navier_stokes_convergence_test(u, x, t, equations)
    ...
    # Density equation
    du1 = (
        rho_t + rho_x * v1 + rho * v1_x + rho_y * v2 + rho * v2_y + rho_z * v3 + rho * v3_z
    )
    # x-momentum equation
    du2 = (
        rho_t * v1 +
        ...
        rho_z * v1 * v3 +
        rho * v1_z * v3 +
        rho * v1 * v3_z - mu_ * (tau11_x + tau12_y + tau13_z)
    )
    # y-momentum equation
    du3 = (
        rho_t * v2 +
        ...
        rho_z * v2 * v3 +
        rho * v2_z * v3 +
        rho * v2 * v3_z - mu_ * (tau12_x + tau22_y + tau23_z)
    )
    # z-momentum equation
    du4 = (
        rho_t * v3 +
        ...
        rho * v2 * v3_y +
        rho_z * v3^2 +
        2.0 * rho * v3 * v3_z - mu_ * (tau13_x + tau23_y + tau33_z)
    )
...
velocity_bc_top_bottom = NoSlip(
    (x, t, equations) ->
        initial_condition_navier_stokes_convergence_test(x, t, equations)[2:4],
)
