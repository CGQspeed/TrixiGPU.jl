...
function (initial_condition::InitialConditionSourceTermsRotated)(
    ...
    rho, rho_v1, rho_v2, rho_e =
        initial_condition_convergence_test(SVector(x1, x2), t, equations)
...
alpha = 0.1
initial_condition_source_terms =
    TrixiExtensionEulerRotated.InitialConditionSourceTermsRotated(alpha)
