...
download(
    "https://github.com/trixi-framework/Trixi_IndicatorNeuralNetwork_networks/raw/main/networks/modelnnpp-0.904-0.0005.bson",
    network,
)
...
indicator_sc = IndicatorNeuralNetwork(
    equations,
    basis,
...
amr_indicator = IndicatorNeuralNetwork(
    semi,
    indicator_type = NeuralNetworkPerssonPeraire(),
    alpha_max = 1.0,
    alpha_min = 0.0001,
...
amr_controller = ControllerThreeLevel(
    ...
    base_level = 4,
    med_level = 6,
    med_threshold = 0.3, # med_level = current level
    max_level = 7,
    max_threshold = 0.5,
)
