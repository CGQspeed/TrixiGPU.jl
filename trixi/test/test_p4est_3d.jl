...
@testset "P4estMesh3D" begin
    ...
    @trixi_testset "elixir_advection_unstructured_curved.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_unstructured_curved.jl"),
    ...
    @trixi_testset "elixir_advection_amr_unstructured_curved.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_advection_amr_unstructured_curved.jl"),
    ...
    @trixi_testset "elixir_euler_source_terms_nonconforming_earth.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_source_terms_nonconforming_earth.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_circular_wind_nonconforming.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_circular_wind_nonconforming.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_baroclinic_instability.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_baroclinic_instability.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_euler_source_terms_nonperiodic_hohqmesh.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_euler_source_terms_nonperiodic_hohqmesh.jl"),
            l2 = [
    ...
    @trixi_testset "elixir_mhd_alfven_wave_nonconforming.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_mhd_alfven_wave_nonconforming.jl"),
            l2 = [
                0.00019018725889431733,
                0.0006523517707148006,
                0.0002401595437705759,
                0.0007796920661427565,
                0.0007095787460334334,
                0.0006558819731628876,
                0.0003565026134076906,
                0.0007904654548841712,
                9.437300326448332e-7,
            ],
            linf = [
                0.0012482306861187897,
                0.006408776208178299,
                0.0016845452099629663,
                0.0068711236542984555,
                0.004626581522263695,
                0.006614624811393632,
                0.0030068344747734566,
                0.008277825749754025,
    ...
    @trixi_testset "elixir_mhd_shockcapturing_amr.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                0.006298541670176575,
                0.0064368506652601265,
                0.007108729762852636,
                0.006530420607206385,
                0.02061185869237284,
                0.005562033787605515,
                0.007571716276627825,
                0.005571862660453231,
            ...
            tspan = (0.0, 0.04),
            coverage_override =
                (maxiters = 6, initial_refinement_level = 1, base_level = 1, max_level = 2)
        )
    end
end
