...
@testset "paper_self_gravitating_gas_dynamics" begin
    ...
    @trixi_testset "elixir_eulergravity_jeans_instability.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_eulergravity_jeans_instability.jl"),
            l2 = [
                10733.63378538114,
                13356.780607423452,
    ...
    @trixi_testset "elixir_eulergravity_sedov_blast_wave.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_eulergravity_sedov_blast_wave.jl"),
            l2 = [
            ...
            linf =
                [2.3874843337593776, 4.07876384374792, 4.07876384374792, 16.23914384809855],
            tspan = (0.0, 0.05),
