...
@testset "Threaded tests" begin
    @testset "TreeMesh" begin
        @trixi_testset "elixir_advection_restart.jl" begin
            @test_trixi_include(
                joinpath(examples_dir(), "tree_2d_dgsem", "elixir_advection_restart.jl"),
    ...
    @testset "DGMulti" begin
        @trixi_testset "elixir_euler_weakform.jl (SBP, EC)" begin
            @test_trixi_include(
                joinpath(examples_dir(), "dgmulti_2d", "elixir_euler_weakform.jl"),
        ...
        @trixi_testset "elixir_euler_fdsbp_periodic.jl" begin
            @test_trixi_include(
                joinpath(examples_dir(), "dgmulti_2d", "elixir_euler_fdsbp_periodic.jl"),
                l2 = [
