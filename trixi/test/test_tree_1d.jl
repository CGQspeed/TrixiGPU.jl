...
@testset "TreeMesh1D" begin
    ...
    @trixi_testset "Nonconservative terms in 1D (linear advection)" begin
        ...
        Trixi.flux(u, orientation, equation::NonconservativeLinearAdvectionEquation) =
            zero(u)
        ...
        Trixi.have_nonconservative_terms(::NonconservativeLinearAdvectionEquation) =
            Trixi.True()
