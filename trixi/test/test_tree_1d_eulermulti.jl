...
@testset "Compressible Euler Multicomponent" begin
    ...
    @trixi_testset "elixir_eulermulti_convergence_es.jl" begin
        @test_trixi_include(
            ...
            l2 = [
                1.8983933794407234e-5,
                6.207744299844731e-5,
                1.5466205761868047e-6,
                3.0932411523736094e-6,
                6.186482304747219e-6,
                1.2372964609494437e-5,
            ],
            linf = [
                0.00012014372605895218,
                0.0003313207215800418,
                6.50836791016296e-6,
                1.301673582032592e-5,
                2.603347164065184e-5,
                5.206694328130368e-5,
            ]
        )
    end
    ...
    @trixi_testset "elixir_eulermulti_two_interacting_blast_waves.jl" begin
        @test_trixi_include(
            joinpath(EXAMPLES_DIR, "elixir_eulermulti_two_interacting_blast_waves.jl"),
            l2 = [
                1.28886761e+00,
                8.27133526e+01,
                3.50680272e-03,
