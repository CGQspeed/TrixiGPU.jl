...
@testset "Visualization tests" begin
    ...
    test_examples_2d = Dict(
        ...
        "StructuredMesh" =>
            ("structured_2d_dgsem", "elixir_euler_source_terms_waving_flag.jl"),
    ...
    @timed_testset "PlotData1D, PlotDataSeries, PlotMesh" begin
        ...
        @test_nowarn_mod trixi_include(
            @__MODULE__,
            joinpath(examples_dir(), "tree_1d_dgsem", "elixir_euler_blast_wave.jl"),
            tspan = (0, 0.1),
        )
    ...
    @timed_testset "PlotData1D (DGMulti)" begin
        ...
        @test_nowarn_mod trixi_include(
            @__MODULE__,
            joinpath(examples_dir(), "dgmulti_1d", "elixir_euler_flux_diff.jl"),
            tspan = (0.0, 0.0),
    ...
    @timed_testset "plot 3D" begin
        @test_nowarn_mod trixi_include(
            @__MODULE__,
            joinpath(examples_dir(), "tree_3d_dgsem", "elixir_advection_basic.jl"),
            tspan = (0, 0.1),
            analysis_callback = Trixi.TrivialCallback(),
        ...
        @test_nowarn_mod trixi_include(
            @__MODULE__,
            joinpath(examples_dir(), "structured_3d_dgsem", "elixir_advection_basic.jl"),
            tspan = (0, 0.1),
        )
